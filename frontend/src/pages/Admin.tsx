...
function StatCard({
  ...
  return (
    <button
      onClick={onClick}
      className={`flex items-center gap-4 px-5 py-3 rounded-2xl border-2 transition-all w-full sm:w-auto ${
        active
          ? "border-amber-500 bg-amber-50 shadow-sm"
          : "border-transparent bg-white hover:border-gray-200 shadow-sm"
      }`}
    >
      <div className={`p-3 rounded-xl ${config?.bg || "bg-gray-100"}`}>
                ...
                <div className="space-y-4">
                  ...
                  {loadingLeads ? (
                    ...
                    <div className="overflow-x-auto rounded-3xl border border-gray-200 bg-white shadow-sm">
                      <table
                        className="min-w-full border-separate border border-gray-200 rounded-3xl"
                        style={{ borderSpacing: 0 }}
                      >
                        <thead className="bg-gray-50">
                          <tr>
                            <th className="border-b border-gray-200 px-4 py-3 text-left text-xs font-semibold uppercase tracking-[0.16em] text-gray-500">
                              Name
                            </th>
                            <th className="border-b border-gray-200 px-4 py-3 text-left text-xs font-semibold uppercase tracking-[0.16em] text-gray-500">
                              Contact
                              ...
                              <td className="border-b border-gray-200 px-4 py-4 whitespace-nowrap">
                                <div className="flex items-center gap-1.5">
                                  ...
                                  <select
                                    ...
                                    className="text-xs border border-gray-200 rounded-lg px-2 py-1.5 bg-white focus:outline-none focus:ring-2 focus:ring-amber-300"
